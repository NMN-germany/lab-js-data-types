...
const part1Lastletter = part1[3].toUpperCase();
const part1Formatted = part1.slice(0, 3) + part1Lastletter;

const part2Lastletter = part2[5].toUpperCase();
const part2Formatted = part2.slice(0, 5) + part2Lastletter;
...
const num = 11
const randomNumber = Math.round(Math.random() * num);
